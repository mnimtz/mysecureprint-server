...
# Status-Codes (aus RFC 8010 / IPP)
STATUS_SUCCESSFUL_OK          = 0x0000
STATUS_SUCCESSFUL_OK_IGNORED  = 0x0001
STATUS_CLIENT_ERROR_BAD       = 0x0400
STATUS_CLIENT_ERROR_NOT_AUTHORIZED   = 0x0402
STATUS_CLIENT_ERROR_FORBIDDEN        = 0x0403
STATUS_CLIENT_ERROR_NOT_FOUND        = 0x0406
STATUS_CLIENT_ERROR_UNSUP_OP  = 0x0501
STATUS_SERVER_ERROR_INTERNAL         = 0x0500
STATUS_SERVER_ERROR_OPERATION_NOT_SUPPORTED = 0x0501

# Alias für einheitliche Bezeichnung
STATUS_OK = STATUS_SUCCESSFUL_OK
...
# Operation-IDs → Namen (für Debug-Logs)
OPERATION_NAMES = {
    0x0002: "Print-Job",
    0x0004: "Validate-Job",
    0x0005: "Create-Job",
    ...
    0x000D: "Pause-Printer",
    0x000E: "Resume-Printer",
    0x000F: "Purge-Jobs",
}
